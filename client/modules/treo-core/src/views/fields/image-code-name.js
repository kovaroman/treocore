...
Espo.define('treo-core:views/fields/image-code-name', 'treo-core:views/fields/varchar-with-pattern',
    Dep => Dep.extend({
        ...
        setup() {
            ...
            if (this.model.isNew()) {
                this.listenTo(this.model, 'change:imageFileName', () => {
                    if (!this.model.get(this.name)) {
                        let value = this.model.get('imageFileName');
                        if (value) {
